...
/**
 * Ordem e definição EXATAS conforme a planilha oficial enviada pelo usuário.
 * 25 colunas em português.
 */
export const COLUNAS_IMPORTACAO: ColunaImportacao[] = [
  ...
  { key: 'dataEntrada',         label: 'Data de Entrada',         obrigatorio: false, largura: 16, descricao: 'Data de entrada na fazenda (DD/MM/AAAA)',       exemplo: '10/01/2023' },
  { key: 'pesoEntrada',         label: 'Peso de Entrada (kg)',    obrigatorio: false, largura: 16, descricao: 'Peso do animal na entrada, em kg',             exemplo: '320' },
  { key: 'produtorOrigem',      label: 'Produtor de Origem',      obrigatorio: false, largura: 20, descricao: 'Nome do produtor/fazenda de origem',           exemplo: 'Fazenda São João' },
  ...
  { key: 'rastreadoNascimento', label: 'Rastreado no Nascimento', obrigatorio: false, largura: 20, descricao: 'Se foi rastreado ao nascer: Sim ou Não',        exemplo: 'Não' },
