    ...
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto p-0 gap-0">
        <DialogHeader className="px-5 py-4 border-b border-gray-100">
          <DialogTitle className="text-[15px] font-semibold text-gray-900">Incluir animais no lote</DialogTitle>
        </DialogHeader>
              ...
              <table className="w-full text-[12px] min-w-[560px]">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="px-3 py-2 text-left text-[10px] font-semibold text-gray-600 uppercase">Raça</th>
                    <th className="px-3 py-2 text-left text-[10px] font-semibold text-gray-600 uppercase">Lote Atual</th>
                    <th className="px-3 py-2 text-left text-[10px] font-semibold text-gray-600 uppercase">Nascimento</th>
                  </tr>
                </thead>
                <tbody>
                  {isLoading ? (
                    ...
                    paginated.map((animal, idx) => (
                      <tr key={animal.id} className={`border-b border-gray-100 ${idx % 2 === 0 ? "bg-white" : "bg-gray-50/60"}`}>
                        ...
                        <td className="px-3 py-2 text-gray-700">{animal.id}</td>
                        ...
                        <td className="px-3 py-2 text-gray-600">{animal.raca || "—"}</td>
                        <td className="px-3 py-2 text-gray-600">{animal.loteNome || "—"}</td>
