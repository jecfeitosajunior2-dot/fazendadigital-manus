  ...
  return (
    <AppLayout>
      <div className="mb-3 flex items-center justify-between">
        ...
        <button className="flex items-center gap-1 px-3 py-1.5 rounded text-white text-[11px] font-medium uppercase" style={{ backgroundColor: "#2D6A4F" }}>
        ...
        <table className="w-full text-[11px]">
          ...
          <tbody>
            <tr className="border-t border-gray-50 hover:bg-gray-50/50">
              <td className="px-3 py-2 text-[#2D6A4F] font-medium cursor-pointer hover:underline">Fazenda Modelo</td>
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-3">
                ...
                <div className="flex-1 h-4 bg-gray-100 rounded overflow-hidden">
                  <div className="h-full rounded" style={{ width: `${item.pct}%`, backgroundColor: "#2D6A4F" }} />
                </div>
      ...
      <div className="bg-white rounded shadow-sm border border-gray-100 overflow-hidden">
        <table className="w-full text-[11px]">
          ...
          <tbody>
            {lots.map((lot, i) => (
              <tr key={i} className="border-t border-gray-50 hover:bg-gray-50/50">
                <td className="px-3 py-1.5 text-[#2D6A4F] font-medium cursor-pointer hover:underline">{lot.name}</td>
      ...
      {tabs.map((tab, i) => (
        <a
          ...
          className={`px-4 py-2 text-[12px] font-medium border-b-2 transition-colors ${
            active === tab ? "border-[#2D6A4F] text-[#2D6A4F]" : "border-transparent text-gray-500 hover:text-gray-700"
          }`}
        >
          {tab}
        </a>
        ...
        {[
          ...
          <div key={i} className="bg-white rounded shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow cursor-pointer">
            <div className="flex items-center gap-3 mb-2">
              <span className="material-icons text-[24px]" style={{ color: "#2D6A4F" }}>{r.icon}</span>
    ...
    <AppLayout>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="bg-white rounded shadow-sm border border-gray-100 p-4">
          ...
          <button className="w-full mt-2 flex items-center justify-center gap-1 px-3 py-1.5 rounded text-white text-[11px] font-medium uppercase" style={{ backgroundColor: "#2D6A4F" }}>
            <span className="material-icons text-[14px]">add</span>
        ...
        {[
          ...
          <a key={i} href={item.path} className="flex items-center gap-3 p-4 bg-white rounded shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            <div className="w-10 h-10 rounded-full bg-green-50 flex items-center justify-center">
              <span className="material-icons text-[20px]" style={{ color: "#2D6A4F" }}>{item.icon}</span>
            </div>
